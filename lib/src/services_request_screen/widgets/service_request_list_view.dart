                ...
                Row(
                  children: [
                    Expanded(
                      child: Center(
                        child: Text(
                          controller.serviceRequestList[index].accountNumber,
                    ...
                    Expanded(
                      child: Center(
                        child: Text(
                          controller.serviceRequestList[index].serviceType,
                          style: const TextStyle(fontWeight: FontWeight.bold),
                        ),
                      ),
                    ),
                    Expanded(
                      child: Center(
                        child: Text(
                          controller.serviceRequestList[index].employeeName ==
                                  ""
                              ? "-----"
                              : controller
                      ...
                      child: Center(
                        child: Text(
                          DateFormat.yMMMd().format(
                              controller.serviceRequestList[index].datecreated),
                          style: const TextStyle(fontWeight: FontWeight.bold),
                        ),
                      ),
                    ),
                    ...
                    controller.serviceRequestList[index].status == false
                        ? Expanded(
                            child: Center(
